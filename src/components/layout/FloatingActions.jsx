...
export default function FloatingActions() {
  ...
  return (
    <>
      {/* Mobile Floating Action: Single Streamlined WhatsApp Concierge Button above Bottom Nav */}
      <div className="fixed bottom-20 right-4 z-40 flex md:hidden">
        <a
          ...
          aria-label="Chat with Pukhraj Jewellers on WhatsApp"
          className="w-12 h-12 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-2xl border border-white/20 active:scale-95 transition-transform"
        >
          <MessageCircle className="w-6 h-6 fill-white text-white" />
        </a>
      </div>

      {/* Desktop Floating Speed-Dial Menu (Unchanged) */}
      <div className="fixed bottom-8 right-5 z-40 hidden md:flex flex-col items-end">
