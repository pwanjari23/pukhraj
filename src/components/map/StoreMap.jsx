...
export default function StoreMap() {
  ...
  return (
    <section id="store-location" className="py-20 md:py-28 bg-[#09090b] text-[#FAF8F5] relative border-b border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Large Desktop / Responsive Interactive Map Panel */}
        <div className="bg-[#121215] border border-[#C5A059]/30 rounded-sm overflow-hidden shadow-2xl grid grid-cols-1 lg:grid-cols-12 items-stretch">
